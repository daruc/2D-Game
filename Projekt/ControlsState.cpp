	...
	: State(window)
{
	...
	left_field->setDescription(L"W lewo");
	...
	right_field->setDescription(L"W prawo");
	...
	crouch_field->setDescription(L"Kucnij");
	...
	jump_field->setDescription(L"Podskocz");
